...
#define HK_REF_PROPERTY_BASE_NEW_PHYSICS 0xf100
...
{
	TYPE* object = reinterpret_cast<TYPE*>(accessProperty( key ));
	if ( !object )
	{
		object = new TYPE;
		addPropertyInternal( key, object, REFERENCE_COUNT_IGNORE );
	}
	return object;
}
