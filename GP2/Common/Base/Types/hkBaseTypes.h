...
#if defined ( HK_COMPILER_MSVC ) &&( _MSC_VER == 1500 ) && defined ( HK_ARCH_X64 ) && !defined ( HK_FULLDEBUG )
...
HK_FORCE_INLINE void hkHalf::setReal<true>(const hkReal& r)
{
	const hkUint32 scale = 0x3F808000; // 1 + 1/256 in float32 representation
	hkFloat32 f = hkFloat32(r);
	f = f * ((const hkFloat32*)&scale)[0];
	int t = ((const int*)&f)[0];
	m_value = hkInt16(t>>16);
}
