...
class hkColor
{
	...
	public:
		...
		inline static hkReal HK_CALL getAlphaAsFloat(int color) { return ((unsigned char)getAlphaAsChar(color)) * hkReal(1.0f / 255.0f); }

			/// Gets the Red component of a color.
		inline static char HK_CALL getRedAsChar(int color) { return char((unsigned(color) >> 16) & 0xFF); }
		inline static hkReal HK_CALL getRedAsFloat(int color) { return ((unsigned char)getRedAsChar(color)) * hkReal(1.0f / 255.0f); }

			/// Gets the Green component of a color.
		inline static char HK_CALL getGreenAsChar(int color) { return char((unsigned(color) >> 8) & 0xFF); }
		inline static hkReal HK_CALL getGreenAsFloat(int color) { return ((unsigned char)getGreenAsChar(color)) * hkReal(1.0f / 255.0f); }

			/// Gets the Blue component of a color.
		inline static char HK_CALL getBlueAsChar(int color) { return char(unsigned(color) & 0xFF); }
		inline static hkReal HK_CALL getBlueAsFloat(int color) { return ((unsigned char)getBlueAsChar(color)) * hkReal(1.0f / 255.0f); }
