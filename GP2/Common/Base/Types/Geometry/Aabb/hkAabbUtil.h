...
class hkAabbUtil
{
	public:
		...
		static HK_FORCE_INLINE void		expandAabbByMotion(const hkAabb& aabbIn, const hkVector4& motion, hkSimdRealParameter anyDirectionExpansion, hkAabb& aabbOut);
		...
		static HK_FORCE_INLINE void		expandAabbByMotion(const hkAabb& aabbIn, const hkVector4& motion, hkAabb& aabbOut);
			...
			/// expand aabb by two different linear motions plus any directoin motion of a body.
		static HK_FORCE_INLINE void		expandAabbByMotion(const hkAabb& aabbIn, hkVector4Parameter motionA, hkVector4Parameter motionB, hkSimdRealParameter anyDirectionExpansion, hkAabb& aabbOut);
