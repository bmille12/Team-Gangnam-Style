...
#if ( HK_CONFIG_SIMD == HK_CONFIG_SIMD_ENABLED) && !defined(HK_REAL_IS_DOUBLE) && ( defined(HK_PLATFORM_WIN32) || defined(HK_PLATFORM_X64) || defined (HK_PLATFORM_PS3_PPU) || defined (HK_PLATFORM_PS3_SPU) || defined( HK_PLATFORM_XBOX360 ) )
