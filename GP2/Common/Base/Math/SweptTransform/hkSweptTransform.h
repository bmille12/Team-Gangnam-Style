...
class hkSweptTransform
{
	...
	public:
		...
		HK_FORCE_INLINE void _approxTransformAt( hkSimdRealParameter time, hkTransform& transformOut ) const;
		...
		void approxTransformAt( hkSimdRealParameter time, hkTransform& transformOut ) const;


			/// get an interpolation value from a given time
		HK_FORCE_INLINE hkReal getInterpolationValue( hkTime t ) const;
		HK_FORCE_INLINE hkSimdReal getInterpolationValue( hkSimdRealParameter t ) const;
		...
		HK_FORCE_INLINE hkSimdReal getInterpolationValueHiAccuracy( hkSimdRealParameter t, hkSimdRealParameter deltaTimeAddon ) const;

			/// Get time0
		HK_FORCE_INLINE hkTime getBaseTime() const;
		HK_FORCE_INLINE hkSimdReal getBaseTimeSr() const;
		...
		HK_FORCE_INLINE hkSimdReal getInvDeltaTimeSr() const;
