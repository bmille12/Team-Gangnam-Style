...
namespace hkSweptTransformUtil
{
		...
		HK_FORCE_INLINE void HK_CALL _lerp2( const hkSweptTransform& sweptTrans, hkSimdRealParameter t, hkQuaternion& quatOut );

			/// inline version of lerp2
		HK_FORCE_INLINE void HK_CALL _lerp2( const hkSweptTransform& sweptTrans, hkReal t, hkTransform& transformOut );
		HK_FORCE_INLINE void HK_CALL _lerp2( const hkSweptTransform& sweptTrans, hkSimdRealParameter t, hkTransform& transformOut );
		...
		void HK_CALL lerp2( const hkSweptTransform& sweptTrans, hkSimdRealParameter time, hkTransform& transformOut );
		...
		void HK_CALL lerp2Ha( const hkSweptTransform& sweptTrans, hkSimdRealParameter t, hkSimdRealParameter tAddOn, hkTransform& transformOut );
		...
		void HK_CALL lerp2Rel( const hkSweptTransform& sweptTrans, hkSimdRealParameter r, hkTransform& transformOut );
		...
		HK_FORCE_INLINE void HK_CALL calcCenterOfMassAt( const hkMotionState& ms, hkSimdRealParameter t, hkVector4& centerOut );
		...
		void HK_CALL backStepMotionState( hkSimdRealParameter t, hkMotionState& motionState );
		...
		void HK_CALL freezeMotionState( hkSimdRealParameter time, hkMotionState& motionState );
		...
		void HK_CALL setTimeInformation( hkSimdRealParameter startTime, hkSimdRealParameter invDeltaTime, hkMotionState& motionState);
