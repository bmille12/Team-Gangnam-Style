...
#if !defined(HK_INT_VECTOR_loadAsFloat32BitRepresentation)
HK_FORCE_INLINE void hkIntVector::loadAsFloat32BitRepresentation(const hkVector4& x)
{
...
HK_FORCE_INLINE void hkIntVector::storeAsFloat32BitRepresentation( hkVector4& out ) const
{
#if defined(HK_REAL_IS_DOUBLE)
...
HK_FORCE_INLINE void hkIntVector::storeInto24LowerBitsOfReal(hkVector4& vOut)
{
...
#elif defined(HK_VECTOR_PARTS_MUST_BE_VALID)
