...
namespace hkVector4Util
{
	...
	HK_FORCE_INLINE void HK_CALL calculatePerpendicularNormalizedVectors(hkVector4Parameter vectorIn, hkVector4& biVectorOut, hkVector4& bi2VectorOut);
	...
	HK_FORCE_INLINE void HK_CALL transformPlane( const hkTransform& transform, const hkVector4& scale, hkVector4& planeInOut );

		/// Scale a plane equation with non-uniform scaling
	HK_FORCE_INLINE void HK_CALL scalePlane(const hkVector4& scale, hkVector4& planeInOut );

	/// Transform a plane equation with non-uniform scaling
	HK_FORCE_INLINE void HK_CALL translatePlane( const hkVector4& translation, hkVector4& planeInOut );
	...
	HK_FORCE_INLINE void HK_CALL dot3_1vs3( hkVector4Parameter vectorIn, hkVector4Parameter a0, hkVector4Parameter a1, hkVector4Parameter a2, hkVector4& dotsOut);
	...
	HK_FORCE_INLINE void HK_CALL dot4_1vs3( hkVector4Parameter vectorIn, hkVector4Parameter a0, hkVector4Parameter a1, hkVector4Parameter a2, hkVector4& dotsOut);

	/// Sets this vector components: this(i) = vector.dot<4>(AI) for i=0..3
	HK_FORCE_INLINE void HK_CALL dot4xyz1_1vs4( hkVector4Parameter vectorIn, hkVector4Parameter a0, hkVector4Parameter a1, hkVector4Parameter a2, hkVector4Parameter a3, hkVector4& dotsOut);
	...
	HK_FORCE_INLINE const hkSimdReal getComponentAtMaskIndex(hkVector4ComparisonParameter cmp, hkVector4Parameter a, hkVector4Parameter b);
	...
	HK_FORCE_INLINE void HK_CALL setXAtVectorMax( hkVector4Parameter check, hkIntVector& iVinOut, hkVector4& v0InOut, hkVector4& v1InOut);
	...
	HK_FORCE_INLINE void HK_CALL setPermutation2(hkVector4Parameter a, hkVector4Parameter b, hkVector4 & out);
