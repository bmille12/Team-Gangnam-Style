...
#ifndef HK_HALF8UTIL_H
#define HK_HALF8UTIL_H
...
public:
	...
	static HK_FORCE_INLINE void pack( hkVector4Parameter v0, hkVector4Parameter v1, hkHalf* HK_RESTRICT packedHalf8 );

	/// Unpacks a vector containing 8 halves into two normal vectors.
	template<hkMathIoMode I>
	static HK_FORCE_INLINE void unpack( const hkHalf* HK_RESTRICT packedHalf8, hkVector4* HK_RESTRICT v0, hkVector4* HK_RESTRICT v1 );

	/// Unpacks the first 4 halves of a vector containing 8 halves.
	static HK_FORCE_INLINE void unpackFirst( hkVector4Parameter packedHalf8, hkVector4& v0 );

	/// Unpacks the second 4 halves of a vector containing 8 halves.
	static HK_FORCE_INLINE void unpackSecond( hkVector4Parameter packedHalf8, hkVector4& v1 );

	/// Packs 2 vectors into a vector containing 8 halves interleaved (v0.x, v1.x, v0.y, v1.y, ...).
	template<hkMathRoundingMode A>
	static HK_FORCE_INLINE void packInterleaved( hkVector4Parameter v0, hkVector4Parameter v1, hkVector4& packedHalf8 );

	/// Unpacks a vector containing 8 halves into two normal vectors.
	static HK_FORCE_INLINE void unpackInterleaved( hkVector4Parameter packedHalf8, hkVector4* HK_RESTRICT v0, hkVector4* HK_RESTRICT v1 );

	/// Unpacks the first 4 halves of a vector containing 8 halves.
	static HK_FORCE_INLINE void unpackFirstInterleaved( hkVector4Parameter packedHalf8, hkVector4& v0 );

	/// Unpacks the second 4 halves of a vector containing 8 halves.
	static HK_FORCE_INLINE void unpackSecondInterleaved( hkVector4Parameter packedHalf8, hkVector4& v1 );
};


#if defined(HK_COMPILER_HAS_INTRINSICS_IA32)
	#if (HK_CONFIG_SIMD == HK_CONFIG_SIMD_ENABLED) && !defined(HK_REAL_IS_DOUBLE)
		#include <Common/Base/Math/Vector/Sse/hkSseHalf8Util.inl>
	#else
		#include <Common/Base/Math/Vector/hkHalf8Util.inl>
	#endif
