...
#define MXV_OP_MXVECTOR_MXVECTOR(METHOD, OP) \
	namespace hkMxVector_Implementation { \
		template <int I> HK_FORCE_INLINE void OP##H(hkVector4* v, const hkVector4* v0, const hkVector4* v1) { OP##H<I-1>(v, v0, v1); v[I-1].OP(v0[I-1], v1[I-1]); } \
		template <> HK_FORCE_INLINE void OP##H<1>(hkVector4* v, const hkVector4* v0, const hkVector4* v1) { v[0].OP(v0[0], v1[0]); }								\
	} \
	template <int M> HK_FORCE_INLINE void hkMxVector<M>::METHOD(hkMxVectorParameter v0, hkMxVectorParameter v1) { hkMxVector_Implementation::OP##H<M>(m_vec.v, v0.m_vec.v, v1.m_vec.v);	}

#define MXV_OP_MXQUATERNION_MXVECTOR(METHOD, OP) \
	namespace hkMxVector_Implementation { \
		template <int I> HK_FORCE_INLINE void OP##H(hkVector4* v, const hkQuaternion* v0, const hkVector4* v1) { OP##H<I-1>(v, v0, v1); v[I-1].OP(v0[I-1], v1[I-1]); } \
		template <> HK_FORCE_INLINE void OP##H<1>(hkVector4* v, const hkQuaternion* v0, const hkVector4* v1) { v[0].OP(v0[0], v1[0]); }									\
	} \
	template <int M> HK_FORCE_INLINE void hkMxVector<M>::METHOD(hkMxQuaternionParameter v0, hkMxVectorParameter v1) { hkMxVector_Implementation::OP##H<M>(m_vec.v, (const hkQuaternion*)v0.m_vec.v, v1.m_vec.v);	}
...
#define MXV_OP_MXREAL_MXSINGLE(METHOD, OP) \
	namespace hkMxVector_Implementation { \
	template <int I> HK_FORCE_INLINE void OP##MX_OP_REAL_SINGLE   (hkVector4* v, const hkSimdReal* s0, hkVector4Parameter v1) { OP##MX_OP_REAL_SINGLE<I-1>(v, s0, v1); v[I-1].OP(s0[I-1], v1); }	\
	template <>      HK_FORCE_INLINE void OP##MX_OP_REAL_SINGLE<1>(hkVector4* v, const hkSimdReal* s0, hkVector4Parameter v1 ) { v[0].OP(s0[0],v1); }							\
	} \
	template <int M> HK_FORCE_INLINE void hkMxVector<M>::METHOD(hkMxRealParameter r, hkMxSingleParameter v0 ) { hkMxVector_Implementation::OP##MX_OP_REAL_SINGLE<M>(m_vec.v, r.m_real.r, v0.m_single.s ); }
...
namespace hkMxVector_Implementation
{
	template <int I> HK_FORCE_INLINE void setBCH(hkVector4* v, hkSimdRealParameter v0) { setBCH<I-1>(v, v0); v[I-1].setAll(v0); }
	template <> HK_FORCE_INLINE void setBCH<1>(hkVector4* v, hkSimdRealParameter v0) { v[0].setAll(v0); }
}
template <int M>
HK_FORCE_INLINE void hkMxVector<M>::setAll( hkSimdRealParameter r )
{
	hkMxVector_Implementation::setBCH<M>(m_vec.v, r);
}
...
template <int I, int N> struct loadRH {
	HK_FORCE_INLINE static void apply(hkVector4* v, const hkReal* r) 
	{ 
...
{
	hkMxVector_Implementation::loadRH<M,N>::apply(m_vec.v, r);
}
...
HK_FORCE_INLINE static void apply(hkVector4* v, const hkReal* base)
{
...
HK_FORCE_INLINE void hkMxVector<M>::load(const hkReal* base)
{
	hkMxVector_Implementation::loadHC<M, byteAddressIncrement, N, A>::apply(m_vec.v, base);
}
...
HK_FORCE_INLINE static void apply(hkVector4* v, const hkHalf* base)
{
...
template <int M>
template <hkUint32 byteAddressIncrement, int N, hkMathIoMode A>
HK_FORCE_INLINE void hkMxVector<M>::loadUnpack(const hkHalf* base)
{
	hkMxVector_Implementation::loadUnpackHC<M, byteAddressIncrement, N, A>::apply(m_vec.v, base);
}
...
HK_FORCE_INLINE static void apply(const hkVector4* v, hkReal* base)
{
	hkReal* HK_RESTRICT ptr0 = hkAddByteOffset(base, (I-1) * byteAddressIncrement); 
...
template <int M>
template <hkUint32 byteAddressIncrement, int N, hkMathIoMode A>
HK_FORCE_INLINE void hkMxVector<M>::store(hkReal* base) const
{
	hkMxVector_Implementation::storeHC<M, byteAddressIncrement, N, A>::apply(m_vec.v, base);
}
...
HK_FORCE_INLINE void hkMxVector<M>::storePack(hkHalf* base) const
{
	hkMxVector_Implementation::storePackHC<M, byteAddressIncrement, N, A, R>::apply(m_vec.v, base);
}
...
MXV_OP_MXVECTOR_MXVECTOR( subMul, subMul )
MXV_OP_MXVECTOR_MXVECTOR( setMin, setMin )
MXV_OP_MXVECTOR_MXVECTOR( setMax, setMax )

MXV_OP_MXREAL_MXVECTOR( addMul, addMul )
MXV_OP_MXREAL_MXVECTOR( subMul, subMul )
MXV_OP_MXREAL_MXVECTOR( setMul, setMul )
MXV_OP_MXREAL_MXSINGLE( setMul, setMul )

MXV_OP_MXQUATERNION_MXVECTOR( setRotatedDir, _setRotatedDir )
MXV_OP_MXQUATERNION_MXVECTOR( setRotatedInverseDir, _setRotatedInverseDir )
...
template <int M, int N> struct hAddHS { HK_FORCE_INLINE static void apply(hkMxVectorParameter v, hkSimdReal& addsOut) { HK_MXVECTOR_MX_NOT_IMPLEMENTED; } };
...
template <int N> struct hAddHS<1,N> { HK_FORCE_INLINE static void apply(const hkMxVector<1>& v, hkSimdReal& addsOut) 
{ 
...
template <int M>
template <int N>
HK_FORCE_INLINE void hkMxVector<M>::horizontalAdd( hkSimdReal& addsOut ) const
{
	hkMxVector_Implementation::hAddHS<M,N>::apply(*this, addsOut);
}
...
namespace hkMxVector_Implementation
{
	...
	template <> struct componentCountToSelectMask<0> { 	enum { Mask = hkVector4Comparison::MASK_NONE }; };
	template <> struct componentCountToSelectMask<1> { 	enum { Mask = hkVector4Comparison::MASK_X }; };
	template <> struct componentCountToSelectMask<2> { 	enum { Mask = hkVector4Comparison::MASK_XY }; };
	template <> struct componentCountToSelectMask<3> { 	enum { Mask = hkVector4Comparison::MASK_XYZ }; };
	template <> struct componentCountToSelectMask<4> { 	enum { Mask = hkVector4Comparison::MASK_XYZW }; };
}

namespace hkMxVector_Implementation
{
template <int I, hkUint32 byteAddressIncrement, hkVector4Comparison::Mask MASK> struct gatherHC {
HK_FORCE_INLINE static void apply(hkVector4* v, const hkVector4* HK_RESTRICT base)
{
...
template <hkUint32 byteAddressIncrement, hkVector4Comparison::Mask MASK> struct gatherHC<1, byteAddressIncrement, MASK> {
HK_FORCE_INLINE static void apply(hkVector4* v, const hkVector4* HK_RESTRICT base)
{
...
HK_FORCE_INLINE void hkMxVector<M>::gather(const hkVector4* HK_RESTRICT base)
{
	hkMxVector_Implementation::gatherHC<M, byteAddressIncrement, hkVector4Comparison::Mask(hkMxVector_Implementation::componentCountToSelectMask<N>::Mask)>::apply(m_vec.v, base);
}
...
namespace hkMxVector_Implementation
{
	template <int I, hkUint32 byteOffset, hkVector4Comparison::Mask M> struct gatherWithOffsetHC {
		HK_FORCE_INLINE static void apply(hkVector4* v, const void** base)
		{
			const hkVector4* HK_RESTRICT ptr0 = (const hkVector4*)hkAddByteOffsetConst(base[I-1], byteOffset); 
	...
	template <hkUint32 byteOffset, hkVector4Comparison::Mask M> struct gatherWithOffsetHC<0, byteOffset, M> {
		HK_FORCE_INLINE static void apply(hkVector4* v, const void** base){}
	};
}
template <int M>
...
HK_FORCE_INLINE void hkMxVector<M>::gatherWithOffset(const void* base[M])
{
	hkMxVector_Implementation::gatherWithOffsetHC<M, byteOffset, hkVector4Comparison::Mask( hkMxVector_Implementation::componentCountToSelectMask<N>::Mask) >::apply(m_vec.v, base);
}
...
template <int M>
template <hkUint32 byteOffset> 
HK_FORCE_INLINE void hkMxVector<M>::gatherHalfsWithOffset(const void* base[M])
{
	hkMxVector_Implementation::gatherHalfsWithOffsetH<M, byteOffset>::apply(m_vec.v, base);
}
...
namespace hkMxVector_Implementation
{
	template <int I, hkUint32 byteOffset, int N, hkMathIoMode A> struct loadWithOffsetHC {
		HK_FORCE_INLINE static void apply(hkVector4* v, const hkReal** base)
		{
			const hkReal* ptr0 = (const hkReal*)hkAddByteOffsetConst(base[I-1], byteOffset); 
...
HK_FORCE_INLINE void hkMxVector<M>::loadWithOffset(const hkReal* base[M])
{
	hkMxVector_Implementation::loadWithOffsetHC<M, byteOffset, N, A>::apply(m_vec.v, base);
}
...
template <int M>
template <hkUint32 byteOffset, int N, hkMathIoMode A> 
HK_FORCE_INLINE void hkMxVector<M>::loadUnpackWithOffset(const hkHalf* base[M])
{
	hkMxVector_Implementation::loadUnpackWithOffsetHC<M, byteOffset, N, A>::apply(m_vec.v, base);
}
...
namespace hkMxVector_Implementation
{
	template <int I, hkUint32 byteAddressIncrement, hkVector4Comparison::Mask M> struct scatterHC {
HK_FORCE_INLINE static void apply(const hkVector4* v, hkVector4* base)
{
	hkVector4* HK_RESTRICT ptr0 = hkAddByteOffset(base, (I-1) * byteAddressIncrement); 
...
template <hkUint32 byteAddressIncrement, hkVector4Comparison::Mask M> struct scatterHC<1, byteAddressIncrement, M> {
HK_FORCE_INLINE static void apply(const hkVector4* v, hkVector4* base)
{
...
HK_FORCE_INLINE void hkMxVector<M>::scatter(hkVector4* base) const
{
	hkMxVector_Implementation::scatterHC<M, byteAddressIncrement, hkVector4Comparison::Mask( hkMxVector_Implementation::componentCountToSelectMask<N>::Mask) >::apply(m_vec.v, base);
}
...
namespace hkMxVector_Implementation
{
template <int I, hkUint32 byteOffset, hkVector4Comparison::Mask M> struct scatterWithOffsetHC {
HK_FORCE_INLINE static void apply(const hkVector4* v, void** base)
{
	hkVector4* HK_RESTRICT ptr0 = (hkVector4*)hkAddByteOffset(base[I-1], byteOffset); 
...
template <hkUint32 byteOffset, hkVector4Comparison::Mask M> struct scatterWithOffsetHC<1, byteOffset, M> {
HK_FORCE_INLINE static void apply(const hkVector4* v, void** base)
{
	hkVector4* HK_RESTRICT ptr0 = (hkVector4*)hkAddByteOffset(base[0], byteOffset); 
...
HK_FORCE_INLINE void hkMxVector<M>::scatterWithOffset(void* base[M]) const 
{
	hkMxVector_Implementation::scatterWithOffsetHC<M, byteOffset, hkVector4Comparison::Mask(hkMxVector_Implementation::componentCountToSelectMask<N>::Mask)>::apply(m_vec.v, base);
}
...
HK_FORCE_INLINE static void apply(const hkVector4* v, hkReal** base)
{
	hkReal* ptr0 = (hkReal*)hkAddByteOffset(base[I-1], byteOffset); 
...
HK_FORCE_INLINE static void apply(const hkVector4* v, hkReal** base)
{
	hkReal* ptr0 = (hkReal*)hkAddByteOffset(base[0], byteOffset); 
	v[0].store<N, A>(ptr0);
} };
}
template <int M>
template <hkUint32 byteOffset, int N, hkMathIoMode A> 
HK_FORCE_INLINE void hkMxVector<M>::storeWithOffset(hkReal* base[M]) const 
{
	hkMxVector_Implementation::storeWithOffsetHC<M, byteOffset, N, A>::apply(m_vec.v, base);
}
...
HK_FORCE_INLINE void hkMxVector<M>::storePackWithOffset(hkHalf* base[M]) const 
{
	hkMxVector_Implementation::storePackWithOffsetHC<M, byteOffset, N, A, R>::apply(m_vec.v, base);
}
...
HK_FORCE_INLINE void hkMxVector<M>::setVectorPermutation(hkMxVectorParameter m)
{
...
HK_FORCE_INLINE void hkMxVector<M>::setComponentPermutation(hkMxVectorParameter m)
{
	hkMxVector_Implementation::permuteComponents<M,P>::apply(m_vec.v, m.m_vec.v);
}


namespace hkMxVector_Implementation
{
template <int I> HK_FORCE_INLINE void setAllH(hkVector4* v, hkVector4Parameter v0) { setAllH<I-1>(v, v0); v[I-1].setAll(v0.getComponent<I-1>()); }
template <> HK_FORCE_INLINE void setAllH<1>(hkVector4* v, hkVector4Parameter v0) { v[0].setAll(v0.getComponent<0>()); }
}
template <int M>
HK_FORCE_INLINE void hkMxVector<M>::setAsBroadcast(hkVector4Parameter v)
{
	hkMxVector_Implementation::setAllH<M>(m_vec.v, v); // safe, v.getComponent will assert M<=4
}

#undef MXV_NO_OPERANDS
#undef MXV_OP_MXVECTOR
#undef MXV_OP_MXVECTOR_MXVECTOR
#undef MXV_OP_MXQUATERNION_MXVECTOR
