...
inline void hkFourTransposedPoints::extract(int index, hkVector4& vI) const
{
	...
	vI.set(m_vertices[0](index), m_vertices[1](index), m_vertices[2](index), hkReal(0));
...
inline void hkFourTransposedPoints::setMulC(const hkFourTransposedPoints& v, hkVector4Parameter a)
{
	hkVector4 ax;	ax.setAll(a.getComponent<0>());
	hkVector4 ay;	ay.setAll(a.getComponent<1>());
	hkVector4 az;	az.setAll(a.getComponent<2>());
...
inline void hkFourTransposedPoints::setMulT(const hkFourTransposedPoints& v, hkVector4Parameter a)
{
...
inline void hkFourTransposedPoints::setMin(const hkFourTransposedPoints& v, const hkFourTransposedPoints& a)
{
...
inline void hkFourTransposedPoints::setMax(const hkFourTransposedPoints& v, const hkFourTransposedPoints& a)
{
...
inline void hkFourTransposedPoints::setAddMulT(const hkFourTransposedPoints& v, const hkFourTransposedPoints& u, hkVector4Parameter a)
{
...
inline void hkFourTransposedPoints::setSubMulT(const hkFourTransposedPoints& v, const hkFourTransposedPoints& u, hkVector4Parameter a)
{
...
inline void hkFourTransposedPoints::addMulT(const hkFourTransposedPoints& u, hkVector4Parameter a)
{
...
inline void hkFourTransposedPoints::subMulT(const hkFourTransposedPoints& u, hkVector4Parameter a)
{
...
inline void hkFourTransposedPoints::mulT(hkVector4Parameter a)
{
	m_vertices[0].mul(a);
	m_vertices[1].mul(a);
	m_vertices[2].mul(a);
...
HK_FORCE_INLINE void hkFourTransposedPoints::setCross(const hkFourTransposedPoints& v, hkVector4Parameter n)
{
	const hkSimdReal nx = n.getComponent<0>();
	const hkSimdReal ny = n.getComponent<1>();
	const hkSimdReal nz = n.getComponent<2>();

	hkVector4 v0;	v0.setMul(v.m_vertices[1], nz);	// y0123 * nz
	hkVector4 v1;	v1.setMul(v.m_vertices[2], nx);	// z0123 * nx
	hkVector4 v2;	v2.setMul(v.m_vertices[0], ny);	// x0123 * ny
...
//
//	Permutates the vectors

template <hkVectorPermutation::Permutation perm>
HK_FORCE_INLINE void hkFourTransposedPoints::setPermutation(const hkFourTransposedPoints& pts)
{
