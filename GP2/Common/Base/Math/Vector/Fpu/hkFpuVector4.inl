...
{
	m_quad.v[0] = (M & hkVector4Comparison::MASK_X) ? trueValue.m_quad.v[0] : falseValue.m_quad.v[0];
	m_quad.v[1] = (M & hkVector4Comparison::MASK_Y) ? trueValue.m_quad.v[1] : falseValue.m_quad.v[1];
	m_quad.v[2] = (M & hkVector4Comparison::MASK_Z) ? trueValue.m_quad.v[2] : falseValue.m_quad.v[2];
	m_quad.v[3] = (M & hkVector4Comparison::MASK_W) ? trueValue.m_quad.v[3] : falseValue.m_quad.v[3];
}


HK_FORCE_INLINE void hkVector4::zeroIfFalse( hkVector4ComparisonParameter comp )
{
	m_quad.v[0] = comp.anyIsSet<hkVector4Comparison::MASK_X>() ? m_quad.v[0] : hkReal(0);
	m_quad.v[1] = comp.anyIsSet<hkVector4Comparison::MASK_Y>() ? m_quad.v[1] : hkReal(0);
	m_quad.v[2] = comp.anyIsSet<hkVector4Comparison::MASK_Z>() ? m_quad.v[2] : hkReal(0);
	m_quad.v[3] = comp.anyIsSet<hkVector4Comparison::MASK_W>() ? m_quad.v[3] : hkReal(0);
}

HK_FORCE_INLINE void hkVector4::zeroIfTrue( hkVector4ComparisonParameter comp )
{
	m_quad.v[0] = comp.anyIsSet<hkVector4Comparison::MASK_X>() ? hkReal(0) : m_quad.v[0];
	m_quad.v[1] = comp.anyIsSet<hkVector4Comparison::MASK_Y>() ? hkReal(0) : m_quad.v[1];
	m_quad.v[2] = comp.anyIsSet<hkVector4Comparison::MASK_Z>() ? hkReal(0) : m_quad.v[2];
	m_quad.v[3] = comp.anyIsSet<hkVector4Comparison::MASK_W>() ? hkReal(0) : m_quad.v[3];
}
...
{
	const hkSimdReal d0 = r.getColumn<0>().dot<3>(v);
	const hkSimdReal d1 = r.getColumn<1>().dot<3>(v);
	const hkSimdReal d2 = r.getColumn<2>().dot<3>(v);
...
HK_FORCE_INLINE void hkVector4::reduceToHalfPrecision()
{
		...
		dest[2] = src[2] & precisionMask;
		dest[3] = src[3] & precisionMask;
		m_quad.v[0] = hkReal(fsrc[0]);
		m_quad.v[1] = hkReal(fsrc[1]);
		m_quad.v[2] = hkReal(fsrc[2]);
		m_quad.v[3] = hkReal(fsrc[3]);
	#else
...
struct unroll_setDiv<A, HK_DIV_SET_HIGH> { HK_FORCE_INLINE static void apply(hkQuadReal& self, hkVector4Parameter a, hkVector4Parameter b)
{
	...
	case HK_ACC_23_BIT: 
		{
			self.v[0] = ((b.m_quad.v[0] == hkReal(0)) ? ((a.m_quad.v[0] < hkReal(0)) ? -HK_REAL_HIGH : HK_REAL_HIGH) : (a.m_quad.v[0] * hkReal(hkMath::rcpF32Approx23Bit(hkFloat32(b.m_quad.v[0])))));
			self.v[1] = ((b.m_quad.v[1] == hkReal(0)) ? ((a.m_quad.v[1] < hkReal(0)) ? -HK_REAL_HIGH : HK_REAL_HIGH) : (a.m_quad.v[1] * hkReal(hkMath::rcpF32Approx23Bit(hkFloat32(b.m_quad.v[1])))));
			self.v[2] = ((b.m_quad.v[2] == hkReal(0)) ? ((a.m_quad.v[2] < hkReal(0)) ? -HK_REAL_HIGH : HK_REAL_HIGH) : (a.m_quad.v[2] * hkReal(hkMath::rcpF32Approx23Bit(hkFloat32(b.m_quad.v[2])))));
			self.v[3] = ((b.m_quad.v[3] == hkReal(0)) ? ((a.m_quad.v[3] < hkReal(0)) ? -HK_REAL_HIGH : HK_REAL_HIGH) : (a.m_quad.v[3] * hkReal(hkMath::rcpF32Approx23Bit(hkFloat32(b.m_quad.v[3])))));
		}
		break;
	case HK_ACC_12_BIT: 
		{
			self.v[0] = ((b.m_quad.v[0] == hkReal(0)) ? ((a.m_quad.v[0] < hkReal(0)) ? -HK_REAL_HIGH : HK_REAL_HIGH) : (a.m_quad.v[0] * hkReal(hkMath::rcpF32Approx12Bit(hkFloat32(b.m_quad.v[0])))));
			self.v[1] = ((b.m_quad.v[1] == hkReal(0)) ? ((a.m_quad.v[1] < hkReal(0)) ? -HK_REAL_HIGH : HK_REAL_HIGH) : (a.m_quad.v[1] * hkReal(hkMath::rcpF32Approx12Bit(hkFloat32(b.m_quad.v[1])))));
			self.v[2] = ((b.m_quad.v[2] == hkReal(0)) ? ((a.m_quad.v[2] < hkReal(0)) ? -HK_REAL_HIGH : HK_REAL_HIGH) : (a.m_quad.v[2] * hkReal(hkMath::rcpF32Approx12Bit(hkFloat32(b.m_quad.v[2])))));
			self.v[3] = ((b.m_quad.v[3] == hkReal(0)) ? ((a.m_quad.v[3] < hkReal(0)) ? -HK_REAL_HIGH : HK_REAL_HIGH) : (a.m_quad.v[3] * hkReal(hkMath::rcpF32Approx12Bit(hkFloat32(b.m_quad.v[3])))));
		}
		break;
	default:         
		{
			self.v[0] = ((b.m_quad.v[0] == hkReal(0)) ? ((a.m_quad.v[0] < hkReal(0)) ? -HK_REAL_HIGH : HK_REAL_HIGH) : (a.m_quad.v[0] / b.m_quad.v[0]));
			self.v[1] = ((b.m_quad.v[1] == hkReal(0)) ? ((a.m_quad.v[1] < hkReal(0)) ? -HK_REAL_HIGH : HK_REAL_HIGH) : (a.m_quad.v[1] / b.m_quad.v[1]));
			self.v[2] = ((b.m_quad.v[2] == hkReal(0)) ? ((a.m_quad.v[2] < hkReal(0)) ? -HK_REAL_HIGH : HK_REAL_HIGH) : (a.m_quad.v[2] / b.m_quad.v[2]));
			self.v[3] = ((b.m_quad.v[3] == hkReal(0)) ? ((a.m_quad.v[3] < hkReal(0)) ? -HK_REAL_HIGH : HK_REAL_HIGH) : (a.m_quad.v[3] / b.m_quad.v[3]));
		}
		break; // HK_ACC_FULL
	}
} };
...
struct unroll_setDiv<A, HK_DIV_SET_MAX> { HK_FORCE_INLINE static void apply(hkQuadReal& self, hkVector4Parameter a, hkVector4Parameter b)
{
	...
	case HK_ACC_23_BIT: 
		{
			self.v[0] = ((b.m_quad.v[0] == hkReal(0)) ? ((a.m_quad.v[0] < hkReal(0)) ? -HK_REAL_MAX : HK_REAL_MAX) : (a.m_quad.v[0] * hkReal(hkMath::rcpF32Approx23Bit(hkFloat32(b.m_quad.v[0])))));
			self.v[1] = ((b.m_quad.v[1] == hkReal(0)) ? ((a.m_quad.v[1] < hkReal(0)) ? -HK_REAL_MAX : HK_REAL_MAX) : (a.m_quad.v[1] * hkReal(hkMath::rcpF32Approx23Bit(hkFloat32(b.m_quad.v[1])))));
			self.v[2] = ((b.m_quad.v[2] == hkReal(0)) ? ((a.m_quad.v[2] < hkReal(0)) ? -HK_REAL_MAX : HK_REAL_MAX) : (a.m_quad.v[2] * hkReal(hkMath::rcpF32Approx23Bit(hkFloat32(b.m_quad.v[2])))));
			self.v[3] = ((b.m_quad.v[3] == hkReal(0)) ? ((a.m_quad.v[3] < hkReal(0)) ? -HK_REAL_MAX : HK_REAL_MAX) : (a.m_quad.v[3] * hkReal(hkMath::rcpF32Approx23Bit(hkFloat32(b.m_quad.v[3])))));
		}
		break;
	case HK_ACC_12_BIT: 
		{
			self.v[0] = ((b.m_quad.v[0] == hkReal(0)) ? ((a.m_quad.v[0] < hkReal(0)) ? -HK_REAL_MAX : HK_REAL_MAX) : (a.m_quad.v[0] * hkReal(hkMath::rcpF32Approx12Bit(hkFloat32(b.m_quad.v[0])))));
			self.v[1] = ((b.m_quad.v[1] == hkReal(0)) ? ((a.m_quad.v[1] < hkReal(0)) ? -HK_REAL_MAX : HK_REAL_MAX) : (a.m_quad.v[1] * hkReal(hkMath::rcpF32Approx12Bit(hkFloat32(b.m_quad.v[1])))));
			self.v[2] = ((b.m_quad.v[2] == hkReal(0)) ? ((a.m_quad.v[2] < hkReal(0)) ? -HK_REAL_MAX : HK_REAL_MAX) : (a.m_quad.v[2] * hkReal(hkMath::rcpF32Approx12Bit(hkFloat32(b.m_quad.v[2])))));
			self.v[3] = ((b.m_quad.v[3] == hkReal(0)) ? ((a.m_quad.v[3] < hkReal(0)) ? -HK_REAL_MAX : HK_REAL_MAX) : (a.m_quad.v[3] * hkReal(hkMath::rcpF32Approx12Bit(hkFloat32(b.m_quad.v[3])))));
		}
		break;
	default:         
		{
			self.v[0] = ((b.m_quad.v[0] == hkReal(0)) ? ((a.m_quad.v[0] < hkReal(0)) ? -HK_REAL_MAX : HK_REAL_MAX) : (a.m_quad.v[0] / b.m_quad.v[0]));
			self.v[1] = ((b.m_quad.v[1] == hkReal(0)) ? ((a.m_quad.v[1] < hkReal(0)) ? -HK_REAL_MAX : HK_REAL_MAX) : (a.m_quad.v[1] / b.m_quad.v[1]));
			self.v[2] = ((b.m_quad.v[2] == hkReal(0)) ? ((a.m_quad.v[2] < hkReal(0)) ? -HK_REAL_MAX : HK_REAL_MAX) : (a.m_quad.v[2] / b.m_quad.v[2]));
			self.v[3] = ((b.m_quad.v[3] == hkReal(0)) ? ((a.m_quad.v[3] < hkReal(0)) ? -HK_REAL_MAX : HK_REAL_MAX) : (a.m_quad.v[3] / b.m_quad.v[3]));
		}
		break; // HK_ACC_FULL
	}
} };
...
{
	hkQuadReal val; unroll_setDiv<A, HK_DIV_SET_ZERO>::apply(val,a,b);
...
{
				  self.v[0] = hkReal(p[0]);
	if ( N >= 2){ self.v[1] = hkReal(p[1]);	}
	if ( N >= 3){ self.v[2] = hkReal(p[2]);	}
	if ( N >= 4){ self.v[3] = hkReal(p[3]);	}
