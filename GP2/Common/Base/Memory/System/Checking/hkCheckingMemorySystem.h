...
class hkCheckingMemorySystem : public hkMemorySystem
{
	...
	public:
		...
		virtual hkResult getAllocationCallStack(const void* ptr, hkUlong* callStack, int& stackSize, hk_size_t& allocSize);
		...
		virtual hkBool32 isCheckCallstackEnabled() const;
