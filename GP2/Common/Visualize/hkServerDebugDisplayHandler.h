...
class hkServerDebugDisplayHandler : public hkReferencedObject, public hkProcess, public hkDebugDisplayHandler
{
	public:
		...
		virtual hkResult setGeometryVisibility(int geometryIndex, bool isVisible, hkUlong id, int tag) { return HK_FAILURE; }
		...
		virtual hkResult displayPoint2d(const hkVector4& position, int colour, int id, int tag); 
		virtual hkResult displayLine2d(const hkVector4& start, const hkVector4& end, int color, int id, int tag);
		virtual hkResult displayTriangle2d(const hkVector4& a, const hkVector4& b, const hkVector4& c, int color, int id, int tag);
		virtual hkResult displayText2d(const char* text, const hkVector4& pos, hkReal sizeScale, int color, int id, int tag);
