...
#ifndef HK_FEATURE_PRODUCT_PHYSICS
// This class was renamed hkMassProperties from hkpMassProperties (inter-product
// rename). In this case the rename patch will be in hkpPatches_2011_3.cxx, but
// it will not be used if the Physics product is not being built. In this case
