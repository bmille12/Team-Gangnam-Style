...
struct hkMassProperties
{
	...
	hkMassProperties() :	m_volume(0.0f),		m_mass(0.0f)	{		m_centerOfMass.setZero();		m_inertiaTensor.setZero();	}
...
struct hkMassDistribution: public hkMassProperties
{
	hkMassDistribution(): hkMassProperties()
	{
		m_mass = 1.0f;
	}
	~hkMassDistribution()
