...
{	
	...
	/// Wrapper that provide support for virtual boundaries.
	...
	/// - void processTetrahedron(const int nodes[4]) const, called to process a tetrahedron (only called if processVolume() return true).
