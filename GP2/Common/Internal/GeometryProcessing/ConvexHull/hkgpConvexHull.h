...
class hkgpConvexHull : public hkReferencedObject
{
	...
	public:
		...
		static hkReal HK_CALL			computeConcavityFromPoints(const hkgpConvexHull* hull, const hkArray<hkVector4>& points);

		/// Compute the approximate concavity of a geometry with respect to a given convex hull.
		static hkReal HK_CALL			computeConcavityFromGeometry(const hkgpConvexHull* hull, const hkGeometry& geometry);
