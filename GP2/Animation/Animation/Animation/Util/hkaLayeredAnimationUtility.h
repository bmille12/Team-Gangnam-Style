...
#ifndef HK_LAYERED_ANIMATION_UTILITY_H
#define HK_LAYERED_ANIMATION_UTILITY_H

#include <Animation/Animation/Rig/hkaSkeleton.h>

/// This utility creates a layered animation for an input animation and a skeleton.
/// The Layered Animation is created by removing the transforms from an animation
/// for bones that do not belong to the partitions provided. 
class hkaLayeredAnimationUtility
{
public:

	HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR(HK_MEMORY_CLASS_ANIM_RUNTIME,hkaLayeredAnimationUtility);

	/// Input structure
	struct Input
	{
		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_ANIM_RUNTIME, hkaLayeredAnimationUtility::Input );
	...
	struct Output
	{
		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_ANIM_RUNTIME, hkaLayeredAnimationUtility::Output );
	...
	static void HK_CALL createLayeredAnimation( const Input& input, Output& output );
...
#endif // HK_LAYERED_ANIMATION_UTILITY_H
