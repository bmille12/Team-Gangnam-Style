...
class hkpPrismaticConstraintData : public hkpConstraintData
{
	...
	HK_DECLARE_CLASS_ALLOCATOR(HK_MEMORY_CLASS_BASE);
		...
		enum 
		{
			...
			SOLVER_RESULT_MAX = 10 // keep in sync with solver res array below
		};
		...
		struct Runtime
		{
			...
			class hkpSolverResults m_solverResults[10/*VC6 doesn't like the scoping for SOLVER_RESULT_MAX*/];
