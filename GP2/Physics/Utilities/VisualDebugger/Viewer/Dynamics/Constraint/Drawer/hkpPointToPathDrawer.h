...
class hkpPointToPathDrawer : public hkpConstraintDrawer
{
	public:
		...
		void drawConstraint(const hkpPointToPathConstraintData* constraintData, const hkTransform& localToWorldA, const hkTransform& localToWorldB, hkDebugDisplayHandler* displayHandler, int id, int tag);	
};
