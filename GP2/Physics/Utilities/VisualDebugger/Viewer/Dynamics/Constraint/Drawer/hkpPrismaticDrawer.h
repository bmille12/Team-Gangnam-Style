...
class hkpPrismaticDrawer : public hkpConstraintDrawer
{
	public:
		...
		void drawConstraint( const hkpPrismaticConstraintData* constraintData, const hkTransform& localToWorldA, const hkTransform& localToWorldB, hkDebugDisplayHandler* displayHandler, int id, int tag);
};
