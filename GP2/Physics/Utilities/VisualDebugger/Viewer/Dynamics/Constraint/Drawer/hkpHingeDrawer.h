...
class hkpHingeDrawer : public hkpConstraintDrawer
{
	public:
		...
		void drawConstraint(const hkpHingeConstraintData* constraintData, const hkTransform& localToWorldA, const hkTransform& localToWorldB, hkDebugDisplayHandler* displayHandler, int id, int tag);
};
