...
class hkpRagdollLimitsDrawer : public hkpConstraintDrawer
{
	public:
		...
		void drawConstraint(const hkpRagdollLimitsData* constraintData, const hkTransform& localToWorldA, const hkTransform& localToWorldB, hkDebugDisplayHandler* displayHandler, int id, int tag);
