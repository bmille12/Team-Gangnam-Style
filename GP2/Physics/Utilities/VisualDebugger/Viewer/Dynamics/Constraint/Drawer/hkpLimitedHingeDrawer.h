...
class hkpLimitedHingeDrawer : public hkpConstraintDrawer
{
	public:
		...
		void drawConstraint(const hkpLimitedHingeConstraintData* constraintData, const hkTransform& localToWorldA, const hkTransform& localToWorldB, hkDebugDisplayHandler* displayHandler, int id, int tag);
