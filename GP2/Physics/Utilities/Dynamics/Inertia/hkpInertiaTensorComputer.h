...
class hkpInertiaTensorComputer: public hkInertiaTensorComputer
{
	public:
		...
		static void HK_CALL setMassProperties(const hkMassProperties& props, hkpRigidBodyCinfo& bodyInfo);
			...
			/// assignment to a hkpRigidBodyCinfo (using "volume" methods).
		static void HK_CALL setAndScaleToDensity(const hkMassProperties& props, hkReal density, hkpRigidBodyCinfo& bodyInfo);

			/// assignment to a hkpRigidBodyCinfo (using "volume" methods).
		static void HK_CALL setAndScaleToMass(const hkMassProperties& props, hkReal mass, hkpRigidBodyCinfo& bodyInfo);
